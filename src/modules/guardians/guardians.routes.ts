...
import GuardianController from './GuardianController.js';
import { protect, authorize } from '../../middlewares/auth.middleware.js';
import { requireInstitutionContext } from '../../middlewares/tenant.middleware.js';
import { validateRequest } from '../../middlewares/validateRequest.js';
import { guardianAttendanceQuerySchema, guardianBulletinQuerySchema, schoolYearQuerySchema } from './guardians.validators.js';
