import { z } from 'zod';
import { ACTIVITY_ALLOWED_EXTENSIONS, STUDENT_ACTIVITY_STATES } from '../constants/activity.constants.js';
import { nonEmptyString, objectIdSchema } from './common.validators.js';
